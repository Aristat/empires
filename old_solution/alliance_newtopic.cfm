<cfif player.allianceID gt 0>
	<a href="index.cfm?page=alliance_forums">Back to alliance forums</a>
	...
	<input type="hidden" name="eflag" value="post_topic">
    <tr>
		<td></td>
		<td>
	...
	<tr>
		<td>Subject:</td>
		<td><input type="Text" name="subject" maxlength="80" size="65"></td>
	</tr>
	<tr>
